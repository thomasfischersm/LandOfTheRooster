...
/**
 * A test for {@link RespawnBattleBuildingPrecondition}.
 */
@RunWith(AndroidJUnit4.class)
@LargeTest
public class RespawnBattleBuildingPreconditionTest extends AbstractBusinessTest{
    ...
    public void evaluate_failed_notABattleBuilding() {
        ...
        // Try precondition
        RespawnBattleBuildingEvent event = new RespawnBattleBuildingEvent(wheatFieldId);
